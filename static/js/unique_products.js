$(document).ready(function () {
  if ($.fn.DataTable.isDataTable("#unique_products_table")) {
    $("#unique_products_table").DataTable().clear().destroy();
  }
  const $table = $("#unique_products_table");
